...
appName="ThingsBoard Entity Data Query Microservice"

appCode="tb-vc-executor"

appMainClass="org.thingsboard.server.vc.ThingsboardVersionControlExecutorApplication"
