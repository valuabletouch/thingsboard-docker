...
appName="ThingsBoard LWM2M Transport Microservice"

appCode="tb-lwm2m-transport"

appMainClass="org.thingsboard.server.lwm2m.ThingsboardLwm2mTransportApplication"
