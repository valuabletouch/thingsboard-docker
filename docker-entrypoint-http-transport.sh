...
APP_NAME="ThingsBoard HTTP Transport Microservice"

APP_SHORT_NAME=tb-http-transport

APP_DIRECTORY=/usr/share/$APP_SHORT_NAME

APP_MAIN_CLASS=org.thingsboard.server.http.ThingsboardHttpTransportApplication
